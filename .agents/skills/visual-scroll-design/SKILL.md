---
name: visual-scroll-design
description: Use when designing or refining background systems, scroll-driven animations, parallax effects, glassmorphism cards, grain textures, space-themed visuals, or any immersive scroll experience. Also use when creating or modifying HeroSection, TeamSection (crew cards/dossier), Backgrounds, SpaceElements, or the overall visual polish of the landing page.
---
